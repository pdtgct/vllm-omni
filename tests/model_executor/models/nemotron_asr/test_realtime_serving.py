...
"""CPU buffer, replay-echo, and row-alignment contracts.

PORT-SESS-001/002/003 preserve admitted-chunk yields, park correlation and
final-tail rules. PORT-DEC-007 checks replay echoes; PORT-DEC-002 addresses
decision rows by batch position. Imports use the real model package.
"""
