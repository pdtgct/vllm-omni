...
"""Model-local realtime session and receipt-ledger contracts.

PORT-RTC-001/002 cover typed construction, immutable geometry, bounded FIFO
receipts, and completion. PORT-LID-001 rejects unknown locale updates while
preserving the prior prompt. Imports use the real model package.
"""
