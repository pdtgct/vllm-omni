...
def test_v1_ordinary_tensor_layout_remains_owned_by_core() -> None:
    # @spec PORT-STATE-002 / PORT-MIG-006
    # Custom state is partitioned and bound by the executable tests in
    # test_runner_dispatch. v0.29 owns ordinary tensor layout directly.
    assert GPUARModelRunner.initialize_kv_cache_tensors is GPUModelRunner.initialize_kv_cache_tensors
