...
class NemotronASRScheduler(OmniARScheduler):  # type: ignore[misc]
    ...
    def _reject_initial_claim(self, request: Request) -> bool:
        ...
        self._rejected_state_claims.update(request.request_id for request in finished)
        return False
    ...
    def _update_request_as_session(
        ...
        # Upstream owns the parked-input counter and queue transition. Keep
        # the validated original lease while installing the next carrier.
        merged_information = session.additional_information
